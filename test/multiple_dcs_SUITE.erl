...
init_per_suite(Config) ->
    ...
    {ok, clocksi} = rpc:call(hd(Nodes), application, get_env, [antidote, txn_prot]),
...
simple_replication_test(Config) ->
    ...
    WriteResult4= rpc:call(Node2,
                           ...
                           [ CommitTime,
                             [{update, {Key1, antidote_crdt_counter, {increment, 1}}}]]),
    ...
    ReadResult4 = rpc:call(Node1,
                           antidote, clocksi_read,
                           [SnapshotTime, Key1, antidote_crdt_counter]),
                ...
                receive
                    {ok, CT3} ->
                        ...
                        ReadResult1 = rpc:call(Node1,
                           antidote, clocksi_read,
                           [Time, Key, antidote_crdt_counter]),
